...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MapboxDraw = {}));
...
const Point$2 = function(ctx, geojson) {
...
var normalize$1 = /*@__PURE__*/getDefaultExportFromCjs(geojsonNormalize);
...
function setupAPI(ctx, api) {
  ...
  api.add = function (geojson) {
    const featureCollection = JSON.parse(JSON.stringify(normalize$1(geojson)));
